...
from .views import GoogleCallbackJWTView, MeView, RegisterView, SystemStatusView, TestEmailView, ProfileAvatarUploadView
...
urlpatterns = [
    ...
    path("auth/upload-avatar/", ProfileAvatarUploadView.as_view(), name="upload_avatar"),
